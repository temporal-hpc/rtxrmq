...
python plot_perf.py time 1 RTX3090Ti ../csv-finales/perf-TRPRO-5975WX-ALG1.csv 'HRMQ'\
                                 ...
                                 ../csv-finales/perf-RTX3090Ti-constBS-ALG5.csv 'RTXRMQ-B ($n_b=2^{9}$)'\
                                 ../csv-finales/perf-RTX3090Ti-constNB-ALG5.csv 'RTXRMQ-B ($B=2^{15}$)'\
...
python plot_perf.py time 1 RTX4090 ../csv-finales/perf-TRPRO-5975WX-ALG1.csv 'HRMQ'\
                                 ...
                                 ../csv-finales/perf-RTX4090-constBS-ALG5.csv 'RTXRMQ-B ($n_b=2^{9}$)'\
                                 ../csv-finales/perf-RTX4090-constNB-ALG5.csv 'RTXRMQ-B ($B=2^{15}$)'\
...
python plot_perf.py time 1 A100 ../csv-finales/perf-TRPRO-5975WX-ALG1.csv 'HRMQ'\
                                 ...
                                 ../csv-finales/perf-A100-constBS-ALG5.csv 'RTXRMQ-B ($n_b=2^{9}$)'\
                                 ../csv-finales/perf-A100-constNB-ALG5.csv 'RTXRMQ-B ($B=2^{15}$)'\
