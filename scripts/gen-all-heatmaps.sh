...
# RTX 6000 ADA
printf "Generating CPU heatmap for: hmap-RTX6000ADA-ALG2.csv............"
python plot_heat_map.py             $PATH_CSV/hmap-RTX6000ADA-ALG2.csv None "Exhaustive" 1
printf "done\n"
printf "Generating CPU heatmap for: hmap-RTX6000ADA-ALG5.csv............"
python plot_best_heatmap_from_3D.py $PATH_CSV/hmap-RTX6000ADA-ALG5.csv "RTXRMQ" 1
printf "done\n"
printf "Generating CPU heatmap for: hmap-RTX6000ADA-ALG7.csv............"
