...
python plot_heat_map.py $PATH_CSV/hmap-TRPRO-5975WX-ALG1.csv    None "\$\\mathrm{REF}_{\\mathrm{CPU}}\$" 1
printf "done\n"

printf "Generating CPU heatmap for: hmap-2X-EPYC9654-96C-ALG1.csv......."
python plot_heat_map.py $PATH_CSV/hmap-2X-EPYC9654-96C-ALG1.csv None "\$\\mathrm{REF}_{\\mathrm{CPU}}\$" 1
printf "done\n"
